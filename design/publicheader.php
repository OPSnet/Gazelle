...
<? } else {
	...
	if ($Season == 'holidays') {
		...
		$style = $holiday_colors[array_rand($holiday_colors)];
	}
    */
?>
	<link href="<?=STATIC_SERVER ?>styles/public/stylesceneaccess.css?v=<?=filemtime(SERVER_ROOT."/static/styles/public/style{$style}.css")?>" rel="stylesheet" type="text/css" />
<? } ?>
