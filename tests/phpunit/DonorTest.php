...
class DonorTest extends TestCase {
    ...
    public function testDonorCreate(): void {
        ...
        $this->assertEquals('static/common/symbols/donor.png', $donor->heartIcon($donor->user()), 'donor-heart-icon-1');
    ...
    public function testDonorStaff(): void {
        ...
        $this->assertEquals('static/common/symbols/donor_6.png', $donor->heartIcon($donor->user()), 'donor-mod-heart-icon');
    ...
    public function testDonorRank(): void {
        ...
        $this->assertEquals('static/common/symbols/donor_2.png', $donor->heartIcon($donor->user()), 'donor-heart-icon-2');
        ...
        $this->assertEquals('static/common/symbols/donor_3.png', $donor->heartIcon($donor->user()), 'donor-heart-icon-3');
        ...
        $this->assertEquals('static/common/symbols/donor_4.png', $donor->heartIcon($donor->user()), 'donor-heart-icon-4');
        ...
        $this->assertEquals('static/common/symbols/donor_5.png', $donor->heartIcon($donor->user()), 'donor-heart-icon-5');
