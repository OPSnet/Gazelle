...
public static function display_golden_rules()
{
    ...
    [ 'n' => "1.4",
      ...
      'long' => "You agree to log into the site regularly in order to keep your account in good standing. Failure to do so will result in your account being disabled. See <a href=\"wiki.php?action=article&name=accountinactivity\">Account Inactivity</a> for more information." ],
    [ 'n' => "2.1",
