...
// Main settings
define('SITE_NAME', 'APOLLO'); //The name of your site
define('NONSSL_SITE_URL', 'apollo.rip'); //The FQDN of your site
define('SSL_SITE_URL', 'apollo.rip'); //The FQDN of your site, make this different if you are using a subdomain for ssl
define('SITE_IP', '127.0.0.1'); //The IP address by which your site can be publicly accessed
define('SERVER_ROOT', '/var/www'); //The root of the server, used for includes, purpose is to shorten the path string
define('ANNOUNCE_URL', 'http://'.NONSSL_SITE_URL.':2095'); //Announce URL
...
define('DEBUG_WARNINGS', false); //Set to true if you want to see PHP warnings in the footer
...
// IRC settings
define('BOT_NICK', 'apollo');
define('BOT_SERVER', 'irc.apollo.rip'); // IRC server address. Used for onsite chat tool.
define('BOT_PORT', 6667);
define('BOT_CHAN', '#APOLLO');
define('BOT_ANNOUNCE_CHAN', '#announce');
define('BOT_STAFF_CHAN', '#theunit');
define('BOT_DISABLED_CHAN', '#disabled'); // Channel to refer disabled users to.
define('BOT_HELP_CHAN', '#help');
define('BOT_DEBUG_CHAN', '#gods');
define('BOT_REPORT_CHAN', '#theunit');
define('BOT_NICKSERV_PASS', '');
define('BOT_INVITE_CHAN','#recruitment'); // Channel for non-members seeking an interview
define('BOT_INTERVIEW_CHAN', '#interview'); // Channel for the interviews
define('BOT_INTERVIEW_NUM', 6);
define('BOT_INTERVIEW_STAFF', '#temple'); // Channel for the interviewers
define('SOCKET_LISTEN_PORT', );
define('SOCKET_LISTEN_ADDRESS', '');
define('ADMIN_CHAN', '#gods');
define('LAB_CHAN', '#');
define('STATUS_CHAN', '#');
...
$Media = array('CD', 'DVD', 'BD', 'Vinyl', 'Soundboard', 'SACD', 'DAT', 'Cassette', 'WEB');
