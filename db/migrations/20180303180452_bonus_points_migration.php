...
class BonusPointsMigration extends AbstractMigration {
	...
	public function up() {
		...
		$this->insert('bonus_item', [
			...
			['Price' =>  20000, 'Amount' =>  1, 'Label' => 'invite', 'MinClass' => 150, 'FreeClass' => 500, 'title' => 'One (1) Invite'],
			/** Makes more sense than 'Buy an invite purchased!' && exception handling for free =>ETM invites */
